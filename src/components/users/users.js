...
const Users = () => {
  ...
  useEffect(()=>{
    let theOptions=UserNames.map((user)=>
      "name: "+user.name+", Email: "+user.Email
    )
    setOptions(theOptions)},[UserNames]
    )
  ...
  <div className="users" style={{display:"flex",flexDirection:"row", justifyContent:"space-around", alignItems:"center",width:"100%"}}>
    <Selected  options={options} setOptions={setOptions} title="Users" UserNames={UserNames} setUserNames={setUserNames}/>
    {/* {!toAdd&&(<div>
